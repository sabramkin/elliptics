...
public:
	...
	void completion_thread() {
		...
		new read_request_manager(&provider, [](std::unique_ptr<ell::dnet_read_request>){ /*TODO: implement*/ });
		new write_request_manager(&provider, [](std::unique_ptr<ell::dnet_write_request>){ /*TODO: implement*/ });
