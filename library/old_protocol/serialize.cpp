...
int serialize_error_response(dnet_net_state *st __attribute__((unused)), const dnet_cmd &cmd_in,
...
int serialize_lookup_request(dnet_net_state *st __attribute__((unused)), std::unique_ptr<n2_request> msg_in,
                             std::unique_ptr<n2_serialized> &out_serialized) {
